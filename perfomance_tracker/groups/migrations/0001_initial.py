    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_type', models.PositiveSmallIntegerField(choices=[(0, 'Очное'), (1, 'Заочное')], verbose_name='Тип обучения')),
        ...
        migrations.AddConstraint(
            model_name='group',
            constraint=models.UniqueConstraint(fields=('stream', 'group_number', 'subgroup', 'education_type'), name='unique_group'),
        ),
    ]
